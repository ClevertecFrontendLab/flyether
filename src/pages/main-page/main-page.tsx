    ...
    <div  className={cx(styles.main, { main_ebuchka: isEbuchka })}>
      <div className={styles.gap}>
        ...
        <div   className={cx(styles.row, { row_s: !isEbuchka })}>
          ...
          <div className={cx(styles.block_row, styles.margin_left_24, { block_row_ebuchka: isEbuchka , block_row_ne_ebuchka: !isEbuchka})}> <div className={styles.ico_p}>Назначить календарь </div><div className={styles.ico_div}><CalendarTwoTone className={styles.ico} twoToneColor='#2f54eb
              '/> Календарь</div></div>
          <div className={cx(styles.block_row, styles.margin_left_24, { block_row_ebuchka: isEbuchka , block_row_ne_ebuchka: !isEbuchka})}><div className={styles.ico_p}> Запонить профиль</div> <div className={styles.ico_div}><IdcardOutlined className={styles.ico} />Профиль</div>
          </div>
        </div>
      </div >
